...
export default function O2MField({
  field,
  value,
  onChange,
  collectionName,
  ...
  // Find the OTHER relation in the same junction table to get the related collection
  ...
  const childCollection = relation?.meta?.manyCollection || "";
  ...
  return (
    <div className="space-y-2 col-span-2">
      ...
      {field.meta.note && (
        <p className="text-xs text-[#9CA3AF]">{field.meta.note}</p>
      )}
